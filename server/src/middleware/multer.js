...
export class Upload {
  ...
  uploadFile() {
    if (this.uploadFileType === 'single') return upload.single(this.file_name);
    if (this.uploadFileType === 'array') return upload.array(this.file_name);
    if (this.uploadFileType === 'fields') return upload.fields(this.file_name);
  }
}
