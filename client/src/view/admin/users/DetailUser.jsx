import { FormDetail, InputForm, SwitchForm, TextAreaForm } from '@/components/form';
  ...
  return (
    <Modal title={typeof show === 'number' ? 'Cập nhật người dùng' : 'Thêm mới người dùng'} show={show} setShow={setShow}>
      <FormDetail handleSubmit={handleSubmit} handleData={handleData} setShow={setShow}>
        ...
        <InputForm id="password" label="Mật khẩu (*)" type="password" className="xl:w-3/12 lg:w-4/12 w-6/12 p-2" register={register} errors={errors} />
