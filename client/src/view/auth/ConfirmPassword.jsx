    ...
    <FormAuth title="Confirm Password" subTitle="Nhập thông tin để tiếp tục">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-4">
          <InputFormAuth id="username" label="Tài khoản (*)" disabled register={register} errors={errors} />
          <InputFormAuth id="token" label="Mã xác nhận (*)" register={register} errors={errors} />
          <InputFormAuth id="password" label="Mật khẩu mới (*)" register={register} errors={errors} />
