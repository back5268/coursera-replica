...
const DataTable = (props) => {
    ...
    const {
        changeStatusApi = () => {
        }, handleChangeStatus = (item) => ({_id: item._id, status: item.status ? 0 : 1})
    } = statusInfo;
                    ...
                    <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                        <div className="overflow-x-auto relative">
                            ...
                            <table className="min-w-full text-left text-sm font-light">
                                <thead
                                    className="bg-neutral-100 font-medium dark:border-neutral-500 dark:text-neutral-800">
                                <tr>
                                        ...
                                        return (
                                            <tr key={index} className="dark:border-neutral-500">
                                                ...
                                                {columns.map((column, i) => {
                                                    return (
                                                        <td key={i}
                                                            className={`border-r px-4 py-4 border-[1px] ${bgColor}`}>
                                                ...
                                                {isStatus && (
                                                    <td className={`border-r px-4 py-4 border-[1px] ${bgColor}`}>
                                                        <div className="flex justify-center items-center">
                                                            <Switch checked={Boolean(item.status)}
                                                    ...
                                                    <td className={`border-r px-4 py-4 border-[1px] ${bgColor}`}>
                                                        <div className="flex gap-2 justify-center items-center">
                                                            ...
                                                            {baseActions.includes('delete') && (
                                                                <Button rounded={true} severity="danger"
